...
function Footer() {
    return(
        <footer className="bg-violet-300 text-white ">
            <div className="flex flex-col items-center p-[55px] space-y-12 lg:flex-row lg:items-start lg:space-y-0 lg:w-[76%] lg:mx-auto lg:max-w-[1150px] lg:py-[75px] lg:px-0">
                ...
                <div className="text-center space-y-9 lg:flex lg:space-y-0 lg:text-left lg:space-x-10 lg:ml-auto xl:space-x-20">
