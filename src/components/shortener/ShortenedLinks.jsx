    ...
    return(
        <>
            {shortenedLinks.map(item => 
                <div className="rounded-lg bg-white w-full lg:flex lg:items-center lg:px-6 lg:py-4">
                    ...
                    <div className="px-4 pb-4 pt-0 lg:p-0 lg:ml-6">
                        <Button className="w-full font-bold lg:w-[100px]" size="xs">{item.copied ? 'Copied!' : 'Copy'}</Button>
                    </div>
                </div>
                )}
