...
function Navbar() {
    ...
    return (
        <nav className='flex items-center px-[7%] py-10'>
            <img src={logo} alt="logo" />
            {showMobileNav && <ul className='fixed top-[100px] left-[7%] w-[86%] bg-violet-200 text-white rounded-xl flex flex-col items-center space-y-8 py-9 px-7 font-bold text-lg'>
